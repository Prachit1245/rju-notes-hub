        ...
        <section className="mb-16">
          <Card className="card-gradient max-w-4xl mx-auto">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-3xl mb-2">Created with ❤️ by Prachit Regmi</CardTitle>
              <Badge className="academic-badge text-lg px-4 py-2">Student Developer</Badge>
            </CardHeader>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="card-gradient text-center">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Free Knowledge</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
          ...
          <Card className="card-gradient border-orange-200 bg-gradient-to-r from-orange-50 to-yellow-50">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-2xl text-orange-800">Non-Commercial Purpose</CardTitle>
              </div>
            </CardHeader>
